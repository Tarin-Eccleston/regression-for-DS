...
# Question 2(a) Under the model from Question 1, what is the estimated ratio of 
# Evelyn’s expected disc width to Morag’s expected disc width?

DW_ratio =  (Y_pred[2] / Y_pred[1] - 1) * 100
# the estimated ratio of Evelyn’s expected disc width to Morag’s expected disc width is ___

# Question 2(b) Compute a confidence interval for this ratio.
